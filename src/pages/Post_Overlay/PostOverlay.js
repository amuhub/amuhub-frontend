            ...
            <div className="comment-section">
              <div className="comment">
                ...
                <div className="comment_body">
                  <p>
                    <span className="commenter_username">dhimkana_xyz</span>
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                    Sed at obcaecati fuga modi, corrupti non.
                  </p>
              ...
              <div className="comment">
                ...
                <div className="comment_body">
                  <p>
                    <span className="commenter_username">_falana_</span>Why
                    height is not reducing according to width
                  </p>
                  <Link to="#" className="reply">
                    Reply
                  </Link>
              ...
              <div className="comment">
                ...
                <div className="comment_body">
                  <p>
                    <span className="commenter_username">_falana_</span>This is
                    a crappy design
                  </p>
                  <Link to="#" className="reply">
                    Reply
              ...
              <div className="comment">
                ...
                <div className="comment_body">
                  <p>
                    <span className="commenter_username">dhimakana._.yo</span>
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                  </p>
                  <Link to="#" className="reply">
                    Reply
              ...
              <div className="comment">
                ...
                <div className="comment_body">
                  <p>
                    <span className="commenter_username">_falana_</span>Hello
                    world
                  </p>
                  <Link to="#" className="reply">
                    Reply
              ...
              <div className="comment">
                ...
                <div className="comment_body">
                  <p>
                    <span className="commenter_username">_falana_</span>Lorem
                    ipsum dolor sit amet consectetur, adipisicing elit. Sed at
                    obcaecati fuga modi, corrupti non.
                  </p>
                  <Link to="#" className="reply">
                    Reply
                  </Link>
